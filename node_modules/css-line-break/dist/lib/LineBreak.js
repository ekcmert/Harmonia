...
var HYPHEN = [HY, BA];
exports.codePointsToCharacterClasses = function (codePoints, lineBreak) {
...
var _lineBreakAtIndex = function (codePoints, classTypes, indicies, index, forbiddenBreaks) {
    ...
    if (exports.UnicodeTrie.get(codePoints[currentIndex]) === ZWJ && (next === ID || next === EB || next === EM)) {
        return exports.BREAK_NOT_ALLOWED;
    }
...
exports.lineBreakAtIndex = function (codePoints, index) {
    ...
    var _a = exports.codePointsToCharacterClasses(codePoints), indicies = _a[0], classTypes = _a[1];
...
exports.inlineBreakOpportunities = function (str, options) {
...
exports.LineBreaker = function (str, options) {
    var codePoints = Util_1.toCodePoints(str);
    var _a = cssFormattedClasses(codePoints, options), indicies = _a[0], classTypes = _a[1], forbiddenBreakpoints = _a[2];
