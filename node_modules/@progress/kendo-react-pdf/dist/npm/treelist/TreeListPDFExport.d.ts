...
export declare class TreeListPDFExport extends React.Component<TreeListPDFExportProps, {}> {
    ...
    static propTypes: {
        ...
        avoidLinks: PropTypes.Requireable<string | boolean>;
        ...
        margin: PropTypes.Requireable<string | number | PropTypes.InferProps<{
            left: PropTypes.Requireable<string | number>;
            top: PropTypes.Requireable<string | number>;
            right: PropTypes.Requireable<string | number>;
            bottom: PropTypes.Requireable<string | number>;
        }>>;
